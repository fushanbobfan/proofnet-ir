...
def sections : List Section := [
  ...
  {
    title := "Commitment-interval par-guard re-entry failure target"
    declarations := [
      Name.str
        `ProofNetIR.SequentialFigure7.NopStep
  ...
  {
    title := "Marked re-entry target sibling-exit causal order"
    declarations := [
      Name.str
        `ProofNetIR.SequentialFigure7.CanonicalTagHistory.RawMarkedBefore
        "total_of_vertex_ne",
      ...
      `ProofNetIR.SequentialFigure7.ContinuationExitOuterTerminalCausalOutcome,
      Name.str
        `ProofNetIR.SequentialFigure7.ContinuationExit
        "outerTerminalCausalOutcome",
      Name.str
        `ProofNetIR.SequentialFigure7.MarkedConclusionChainFirstCausalDescent
      ...
      Name.str
        `ProofNetIR.SequentialFigure7.WaitStep
        ("commitmentInterval_parTraceReentryMarkedContinuation" ++
          "SiblingExitCausalOutcome")
    ]
  },
  {
    title := "Marked re-entry target sibling-exit causal/cyclic junction"
    declarations := [
      Name.str
        `ProofNetIR.SequentialFigure7.MarkedConclusionChainFirstCausalDescent
      ...
      Name.str
        `ProofNetIR.SequentialFigure7.WaitStep
        ("commitmentInterval_parTraceReentryMarkedContinuation" ++
          "SiblingExitCausalJunctionOutcome")
    ]
  },
  {
  ...
  {
    title := "Marked re-entry target sibling open exits"
    declarations := [
      Name.str
        `ProofNetIR.SequentialFigure7.MarkedConclusionChain
        "terminalComparable",
      Name.str
        `ProofNetIR.SequentialFigure7
        "ContinuationExitRawOrFuture",
      Name.str
        `ProofNetIR.SequentialFigure7.MarkedConclusionChainFirstCausalDescent
        "sourceExitRawOrFuture",
      Name.str
        `ProofNetIR.SequentialFigure7
        ("ActiveCarrierExternalReentryMarkedMateSeparatedContinuation" ++
          "SiblingExitOpenTarget"),
      Name.str
        (Name.str
          `ProofNetIR.SequentialFigure7
          ("ActiveCarrierExternalReentryMarkedMateSeparatedContinuation" ++
      ...
      Name.str
        `ProofNetIR.SequentialFigure7.WaitStep
        ("commitmentInterval_parTraceReentryMarkedContinuation" ++
          "SiblingExitOpenOutcome")
    ]
  },
  {
    title := "Marked re-entry target sibling temporal exits"
    declarations := [
      Name.str
        `ProofNetIR.SequentialFigure7
  ...
  {
    title := "Marked re-entry target active-mate waiting external temporal outcome"
    declarations := [
      ...
      `ProofNetIR.SequentialFigure7.FutureWorkMateActiveCarrierExternalTemporalStatus,
      Name.str
        `ProofNetIR.SequentialFigure7.FutureWorkMateActiveCarrierReadyEliminatedStatus
      ...
      Name.str
        `ProofNetIR.SequentialFigure7.WaitStep
        ("commitmentInterval_parTraceReentryMarkedContinuation" ++
          "SiblingExitExternalTemporalOutcome")
    ]
  },
  {
  ...
  {
    title := "Waiting commitment re-entry marked-target continuation waiting"
    declarations := [
  ...
  {
    title := "Waiting commitment re-entry queue-status outcome"
    declarations := [
      Name.str
        `ProofNetIR.SequentialFigure7
        ("ActiveMateWaitingParentExternalCommitmentReentry" ++
  ...
  {
    title := "Continuation external re-entry queue status"
    declarations := [
      Name.str
        `ProofNetIR.SequentialFigure7
  ...
  {
    title := "Continuation sibling external re-entry queue status"
    declarations := [
      Name.str
        `ProofNetIR.SequentialFigure7
  ...
  {
    title := "Active-top debt parent external temporal outcome"
    declarations := [
  ...
  {
    title := "Active-top debt parent external commitment outcome"
    declarations := [
      Name.str
        `ProofNetIR.SequentialFigure7.CanonicalTagHistory
        "StrictOlderCommitmentSplit",
      Name.str
        `ProofNetIR.SequentialFigure7.CanonicalTagHistory
  ...
  },
  {
    ...
    declarations := [
      ...
      Name.str
        `ProofNetIR.SequentialFigure7.ReservationEvent.TouchSeparatedFrom
        "sourceLeftRegionsDisjoint",
      Name.str
        `ProofNetIR.SequentialFigure7.SourceLeftRegionsDisjoint
        "iff_eventTouchSeparated",
