...
| Manin, *A Course in Mathematical Logic for Mathematicians* | 389 | contents/theorem sweep and prior Chapter IX close read; new [ordered page matrix](source-pages/manin-mathematical-logic.md) directly accounts for physical pages 1-240, including visual inspection of the extraction-empty cover and the Kochen-Specker graphs on physical pages 99-100 | ordered audit 240/389; incomplete |
