...
| Manin, *A Course in Mathematical Logic for Mathematicians* | 389 | contents/theorem sweep and prior Chapter IX close read; new [ordered page matrix](source-pages/manin-mathematical-logic.md) directly accounts for physical pages 1-288, including visual inspection of the extraction-empty cover and the Kochen-Specker graphs on physical pages 99-100 | ordered audit 288/389; incomplete |
