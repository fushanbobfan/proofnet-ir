...
| Manin, *A Course in Mathematical Logic for Mathematicians* | 389 | contents/theorem sweep and prior Chapter IX close read; new [ordered page matrix](source-pages/manin-mathematical-logic.md) directly accounts for physical pages 1-48, including visual inspection of the extraction-empty cover | ordered audit 48/389; incomplete |
