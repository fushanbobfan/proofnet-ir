...
| Rolling research | `v0.10.0-dev`; proof `a064949`; audit `1e46573` | Active | This page/commits |
...
The public decision is the sequential fast path alone:
`Certificate.unificationCheck` is `sequentialFastCheck` (ledger item D2,
...
```text
commit    a0649499985a4066adb0618afa68f5c570138c89
tree      5c38df7cfa049375018643898313b58c90f9b68a
parent    5f60f175d02f341bc0ce5fad6f5e838322855036
stage     make the sequential fast path the public decision and close D2
delta     23 paths, +225/-188
manifest  9C5EA7DC08E6C6D05FE86848B844813ECA5101F85A58977E9847849CA9E73509
```
...
```text
sequential source  EA7E0D77E0F260091845BFD49D78FB8D8B830BE47CAA8F40BDED13201D9AE9A9
sequential consumer 45207C3E905A9FA1385CC135E0E5EFC8A1C381E2924899BFE57D46588C8C98B0
generated API      8570153CC3FAE6FE811E1FF7DD17A627214E5C7AAD4D2C753E328DE91128F982
```
...
- the new public theorem and the relocated decision theorems report exactly
  `propext`, `Classical.choice`, and `Quot.sound`; the module and its
  consumer compile under `--trust=0`, and the consumer printed `Sequential
  consumer passed: final structure, inference, par/tensor numbering,
  equivalence, completeness, public decision`;
- public theorem audit: 1157 entries total: 859 standard-three, 25 axiom-free,
  132 `propext`-only, and 141 `propext`/`Quot.sound` boundaries;
- every CI executable that calls the public decision passed locally: the
  main tests, the new-progress audit, all four tail-law search modes, the
  unification audit (1,500 cases, decision equal to the reference), the
  completeness search, the reconstruction audit and stress, the benchmark
  (291 inputs: sequential decision 68 ms, reference check 513 ms), and the
  downstream consumer smoke package;
- generated API reference current; convergence check passed (no new module,
  one new public theorem, 29 library lines, 12 prose lines net growth);
...
- workflow: `Lean CI`;
- event/ref: `push` / `main`;
- run: [35543526860](https://github.com/fushanbobfan/proofnet-ir/actions/runs/35543526860);
- build job: [106165325373][proof-job];
- title/attempt: `feat: make the sequential fast path the public decision and close D2` / 1;
- exact head: `a0649499985a4066adb0618afa68f5c570138c89`;
- result: 41 successful steps, 0 failures, and 1 expected
  release-ref-only skip;
- run: `2026-09-20T23:04:03Z`-`2026-09-20T23:21:13Z` (17m10s);
- build job: `2026-09-20T23:04:07Z`-`2026-09-20T23:21:12Z`
  (17m05s).

[proof-job]: https://github.com/fushanbobfan/proofnet-ir/actions/runs/35543526860/job/106165325373
