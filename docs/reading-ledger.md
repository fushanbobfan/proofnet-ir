...
| Manin, *A Course in Mathematical Logic for Mathematicians* | 389 | 186,440 | [ordered page audit](source-pages/manin-mathematical-logic.md) now covers physical pages 1-96; prior contents/theorem sweep and Chapter IX §§1-6 close read retained | `79baf1ed4e81` |
